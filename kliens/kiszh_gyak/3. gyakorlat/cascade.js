class CascadeSelect extends HTMLElement {
    ...
    connectedCallback() {
        this.collectOptions(); // adatok kigyujtese
        this.createSelects(); // 2 select létrehozása, eredeti hide, 1. töltése
        this.populate();
        this.groupSelect.addEventListener('change', this.populate); // 1. change -> 2. töltése
    }
